...
/** OpenAI-compatible token counters accepted by {@link mapUsage}. */
export interface RawUsage {
  /** Tokens consumed by prompts/messages. */
...
export interface ChatCompletion {
  /** Completion choices containing either a final message or streamed delta. */
  choices?: Array<{ message?: { content?: string }; delta?: { content?: string } }>;
  /** Optional OpenAI-compatible token accounting. */
  usage?: RawUsage;
}
