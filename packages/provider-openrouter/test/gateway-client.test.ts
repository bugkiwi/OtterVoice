...
describe('server-managed OpenRouter audio-turn clients', () => {
  it('omit every provider and business-policy field from app requests', async () => {
    ...
    const asrSession = await asr.createSession({
