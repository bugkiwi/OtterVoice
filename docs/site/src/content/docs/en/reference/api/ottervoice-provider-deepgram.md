...
| Parameter | Type | Description |
| ------ | ------ | ------ |
| `options` | [`DeepgramOptions`](/docs/en/reference/api/ottervoice-provider-deepgram/#deepgramoptions) | Credentials plus listen URL / query options. Prefer `tokenBrokerUrl` on clients. |
