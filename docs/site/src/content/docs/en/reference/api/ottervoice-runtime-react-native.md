...
| ------ | ------ | ------ | ------ | ------ |
| <a id="startpcmstream"></a> `startPcmStream?` | `readonly` | (`options`) => `Promise`\<[`AudioOutputStream`](/docs/en/reference/api/ottervoice-core/#audiooutputstream)\> | Begin incremental raw-PCM playback for low-latency speech streaming. | [runtime-react-native/src/audio-output.ts:129](https://github.com/bugkiwi/OtterVoice/blob/38d35fd4265628fb518c48aee7e4049fa48cc69f/packages/runtime-react-native/src/audio-output.ts#L129) |
...
| <a id="createsound"></a> `createSound` | (`uri`) => `Promise`\<[`ExpoSound`](/docs/en/reference/api/ottervoice-runtime-react-native/#exposound)\> | Load a sound from a URI (wrap `createAudioPlayer`). | [runtime-react-native/src/audio-output.ts:73](https://github.com/bugkiwi/OtterVoice/blob/38d35fd4265628fb518c48aee7e4049fa48cc69f/packages/runtime-react-native/src/audio-output.ts#L73) |
