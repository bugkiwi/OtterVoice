...
| ------ | ------ | ------ | ------ |
| <a id="lastoptions"></a> `lastOptions` | \| [`AudioInputOptions`](/docs/reference/api/ottervoice-core/#audioinputoptions) \| `undefined` | `undefined` | [packages/core/src/providers/mock-runtime.ts:31](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock-runtime.ts#L31) |
...
| <a id="played"></a> `played` | [`AudioPlaybackInput`](/docs/reference/api/ottervoice-core/#audioplaybackinput)[] | `[]` | [packages/core/src/providers/mock-runtime.ts:107](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock-runtime.ts#L107) |
...
| ------ | ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="cause"></a> `cause?` | `readonly` | `unknown` | Original thrown value. May contain user or provider data. | [`NormalizedVoiceError`](/docs/reference/api/ottervoice-core/#normalizedvoiceerror).[`cause`](/docs/reference/api/ottervoice-core/#cause-2) `Error.cause` | - | [packages/core/src/errors.ts:52](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/errors.ts#L52) |
| <a id="code"></a> `code` | `readonly` | [`VoiceErrorCode`](/docs/reference/api/ottervoice-core/#voiceerrorcode-1) | Stable application error code. | - | - | [packages/core/src/errors.ts:38](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/errors.ts#L38) |
...
| <a id="stage"></a> `stage?` | `readonly` | [`VoiceErrorStage`](/docs/reference/api/ottervoice-core/#voiceerrorstage-1) | Processing boundary where the failure occurred. | - | - | [packages/core/src/errors.ts:42](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/errors.ts#L42) |
...
| <a id="role"></a> `role` | [`TurnRole`](/docs/reference/api/ottervoice-core/#turnrole) | Speaker role for the new turn. | [packages/core/src/transcript-buffer.ts:9](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/transcript-buffer.ts#L9) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="turns"></a> `turns` | [`VoiceTurn`](/docs/reference/api/ottervoice-core/#voiceturn)[] | Completed turns in chronological order. | [packages/core/src/types.ts:1029](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1029) |
...
| <a id="turns-1"></a> `turns` | [`VoiceTurn`](/docs/reference/api/ottervoice-core/#voiceturn)[] | Completed turns in chronological order (includes the latest user turn). | [packages/core/src/types.ts:1018](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1018) |
...
| <a id="confidence"></a> `confidence?` | `boolean` | Whether [ASRResult.confidence](/docs/reference/api/ottervoice-core/#confidence-1) may be populated. | [packages/core/src/types.ts:277](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L277) |
...
| <a id="partialresults"></a> `partialResults` | `boolean` | Whether provisional results are available via [ASRSession.onPartial](/docs/reference/api/ottervoice-core/#onpartial). | [packages/core/src/types.ts:273](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L273) |
...
| <a id="wordtimestamps"></a> `wordTimestamps?` | `boolean` | Whether [ASRResult.words](/docs/reference/api/ottervoice-core/#words) may include timing. | [packages/core/src/types.ts:275](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L275) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="capabilities"></a> `capabilities` | [`ASRCapabilities`](/docs/reference/api/ottervoice-core/#asrcapabilities) | Declared feature flags used by the session when routing audio. | [packages/core/src/types.ts:385](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L385) |
...
| <a id="words"></a> `words?` | [`ASRWord`](/docs/reference/api/ottervoice-core/#asrword)[] | Optional word timestamps. | [packages/core/src/types.ts:325](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L325) |
...
| <a id="format"></a> `format` | [`AudioLLMInputFormat`](/docs/reference/api/ottervoice-core/#audiollminputformat) | Container / codec of `audio`. | [packages/core/src/types.ts:509](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L509) |
...
| <a id="messages"></a> `messages` | [`LLMMessage`](/docs/reference/api/ottervoice-core/#llmmessage)[] | Text history from completed earlier turns. | [packages/core/src/types.ts:511](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L511) |
...
| <a id="usage"></a> `usage?` | [`LLMUsage`](/docs/reference/api/ottervoice-core/#llmusage) | Token usage when reported. | [packages/core/src/types.ts:540](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L540) |
...
| <a id="retryable-1"></a> `retryable?` | `boolean` | Override the default retryability for [VoiceErrorCode](/docs/reference/api/ottervoice-core/#voiceerrorcode-1). | [packages/core/src/errors.ts:106](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/errors.ts#L106) |
...
| <a id="stage-1"></a> `stage?` | [`VoiceErrorStage`](/docs/reference/api/ottervoice-core/#voiceerrorstage-1) | Processing boundary where the failure occurred. | [packages/core/src/errors.ts:102](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/errors.ts#L102) |
...
| <a id="messages-1"></a> `messages` | [`LLMMessage`](/docs/reference/api/ottervoice-core/#llmmessage)[] | Chronological chat history for the model. | [packages/core/src/types.ts:424](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L424) |
...
| <a id="usage-1"></a> `usage?` | [`LLMUsage`](/docs/reference/api/ottervoice-core/#llmusage) | Token usage when reported. | [packages/core/src/types.ts:444](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L444) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="error"></a> `error?` | [`NormalizedVoiceError`](/docs/reference/api/ottervoice-core/#normalizedvoiceerror) | Normalized failure for `error`. | [packages/core/src/types.ts:458](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L458) |
...
| <a id="usage-2"></a> `usage?` | [`LLMUsage`](/docs/reference/api/ottervoice-core/#llmusage) | Usage snapshot for `usage` / `done`. | [packages/core/src/types.ts:456](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L456) |
...
| <a id="usage-3"></a> `usage?` | [`LLMUsage`](/docs/reference/api/ottervoice-core/#llmusage) | Token usage returned on every `generate` / stream completion. | [packages/core/src/providers/mock.ts:121](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock.ts#L121) |
...
| ------ | ------ | ------ | ------ | ------ | ------ |
| <a id="audioinput"></a> `audioInput` | [`MockAudioInput`](/docs/reference/api/ottervoice-core/#mockaudioinput) | Controllable mock microphone. | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter).[`audioInput`](/docs/reference/api/ottervoice-core/#audioinput-1) | - | [packages/core/src/providers/mock-runtime.ts:196](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock-runtime.ts#L196) |
| <a id="audiooutput"></a> `audioOutput` | [`MockAudioOutput`](/docs/reference/api/ottervoice-core/#mockaudiooutput) | Controllable mock speaker. | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter).[`audioOutput`](/docs/reference/api/ottervoice-core/#audiooutput-1) | - | [packages/core/src/providers/mock-runtime.ts:198](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock-runtime.ts#L198) |
| <a id="logger"></a> `logger?` | [`LoggerAdapter`](/docs/reference/api/ottervoice-core/#loggeradapter) | Optional logger; core uses it sparingly. | - | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter).[`logger`](/docs/reference/api/ottervoice-core/#logger-1) | [packages/core/src/types.ts:1005](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1005) |
| <a id="network"></a> `network?` | [`NetworkAdapter`](/docs/reference/api/ottervoice-core/#networkadapter) | Optional HTTP/WebSocket hooks for providers. | - | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter).[`network`](/docs/reference/api/ottervoice-core/#network-1) | [packages/core/src/types.ts:1001](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1001) |
| <a id="storage"></a> `storage?` | [`RuntimeStorageAdapter`](/docs/reference/api/ottervoice-core/#runtimestorageadapter) | Optional persistence for caches. | - | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter).[`storage`](/docs/reference/api/ottervoice-core/#storage-1) | [packages/core/src/types.ts:1003](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1003) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="input"></a> `input?` | [`MockAudioInputOptions`](/docs/reference/api/ottervoice-core/#mockaudioinputoptions) | Microphone mock options. See [MockAudioInputOptions](/docs/reference/api/ottervoice-core/#mockaudioinputoptions). | [packages/core/src/providers/mock-runtime.ts:185](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/providers/mock-runtime.ts#L185) |
...
| <a id="code-1"></a> `code` | [`VoiceErrorCode`](/docs/reference/api/ottervoice-core/#voiceerrorcode-1) | Stable application error code. | [packages/core/src/types.ts:85](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L85) |
...
| <a id="stage-2"></a> `stage?` | [`VoiceErrorStage`](/docs/reference/api/ottervoice-core/#voiceerrorstage-1) | Processing boundary where the failure occurred. | [packages/core/src/types.ts:91](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L91) |
...
| <a id="words-1"></a> `words?` | [`ASRWord`](/docs/reference/api/ottervoice-core/#asrword)[] | Optional word timings from ASR to align scoring. | [packages/core/src/types.ts:666](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L666) |
...
| <a id="name-5"></a> `name` | `string` | Stable profile id (usually matches a [ProviderProfileName](/docs/reference/api/ottervoice-core/#providerprofilename-1)). | [packages/core/src/provider-router.ts:25](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L25) |
...
| <a id="feature"></a> `feature?` | [`ProviderFeature`](/docs/reference/api/ottervoice-core/#providerfeature) | Feature being selected (optional; ignored by the default policy). | [packages/core/src/provider-router.ts:105](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L105) |
...
| <a id="plan"></a> `plan?` | [`ProviderPlan`](/docs/reference/api/ottervoice-core/#providerplan) | Subscription tier. | [packages/core/src/provider-router.ts:103](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L103) |
| <a id="region"></a> `region?` | [`ProviderRegion`](/docs/reference/api/ottervoice-core/#providerregion) | User / deployment region. | [packages/core/src/provider-router.ts:101](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L101) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="asr-1"></a> `asr?` | `Record`\<`string`, [`ASRProvider`](/docs/reference/api/ottervoice-core/#asrprovider)\> | ASR adapters keyed by profile `asr` id. | [packages/core/src/provider-router.ts:133](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L133) |
| <a id="llm"></a> `llm?` | `Record`\<`string`, [`LLMProvider`](/docs/reference/api/ottervoice-core/#llmprovider)\> | LLM adapters keyed by conversation / scoring ids. | [packages/core/src/provider-router.ts:135](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L135) |
| <a id="pronunciation-1"></a> `pronunciation?` | `Record`\<`string`, [`PronunciationProvider`](/docs/reference/api/ottervoice-core/#pronunciationprovider)\> | Pronunciation adapters keyed by profile `pronunciation` id. | [packages/core/src/provider-router.ts:139](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L139) |
| <a id="tts-1"></a> `tts?` | `Record`\<`string`, [`TTSProvider`](/docs/reference/api/ottervoice-core/#ttsprovider)\> | TTS adapters keyed by profile `tts` id. | [packages/core/src/provider-router.ts:137](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L137) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="asr-2"></a> `asr` | [`ASRProvider`](/docs/reference/api/ottervoice-core/#asrprovider) | Live ASR for the classic pipeline. | [packages/core/src/provider-router.ts:148](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L148) |
| <a id="llm-1"></a> `llm` | [`LLMProvider`](/docs/reference/api/ottervoice-core/#llmprovider) | Conversational text LLM. | [packages/core/src/provider-router.ts:150](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L150) |
| <a id="llmscoring-1"></a> `llmScoring` | [`LLMProvider`](/docs/reference/api/ottervoice-core/#llmprovider) | LLM used for scoring / reports (may alias [ResolvedProviders.llm](/docs/reference/api/ottervoice-core/#llm-1)). | [packages/core/src/provider-router.ts:152](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L152) |
...
| <a id="tts-2"></a> `tts?` | [`TTSProvider`](/docs/reference/api/ottervoice-core/#ttsprovider) | Optional TTS when synthesizing speech separately. | [packages/core/src/provider-router.ts:154](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/provider-router.ts#L154) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="audioinput-1"></a> `audioInput` | [`AudioInputAdapter`](/docs/reference/api/ottervoice-core/#audioinputadapter) | Microphone / capture side. | [packages/core/src/types.ts:997](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L997) |
| <a id="audiooutput-1"></a> `audioOutput` | [`AudioOutputAdapter`](/docs/reference/api/ottervoice-core/#audiooutputadapter) | Speaker / playback side. | [packages/core/src/types.ts:999](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L999) |
| <a id="logger-1"></a> `logger?` | [`LoggerAdapter`](/docs/reference/api/ottervoice-core/#loggeradapter) | Optional logger; core uses it sparingly. | [packages/core/src/types.ts:1005](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1005) |
| <a id="network-1"></a> `network?` | [`NetworkAdapter`](/docs/reference/api/ottervoice-core/#networkadapter) | Optional HTTP/WebSocket hooks for providers. | [packages/core/src/types.ts:1001](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1001) |
| <a id="storage-1"></a> `storage?` | [`RuntimeStorageAdapter`](/docs/reference/api/ottervoice-core/#runtimestorageadapter) | Optional persistence for caches. | [packages/core/src/types.ts:1003](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1003) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="formats"></a> `formats` | [`TTSFormat`](/docs/reference/api/ottervoice-core/#ttsformat)[] | Output formats the adapter can produce. | [packages/core/src/types.ts:591](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L591) |
...
| <a id="voices"></a> `voices` | [`TTSVoice`](/docs/reference/api/ottervoice-core/#ttsvoice)[] | Voices advertised by the adapter. | [packages/core/src/types.ts:589](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L589) |
...
| <a id="format-1"></a> `format?` | [`TTSFormat`](/docs/reference/api/ottervoice-core/#ttsformat) | Preferred output container / codec. | [packages/core/src/types.ts:609](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L609) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="capabilities-1"></a> `capabilities` | [`TTSCapabilities`](/docs/reference/api/ottervoice-core/#ttscapabilities) | Declared voices and formats. | [packages/core/src/types.ts:640](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L640) |
...
| <a id="id-1"></a> `id` | `string` | Stable voice id passed to [TTSInput.voice](/docs/reference/api/ottervoice-core/#voice). | [packages/core/src/types.ts:573](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L573) |
...
| <a id="strategy"></a> `strategy` | [`TurnDetectionStrategy`](/docs/reference/api/ottervoice-core/#turndetectionstrategy) | How end-of-utterance is decided. | [packages/core/src/types.ts:1085](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1085) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="agent"></a> `agent?` | [`VoiceAgentPlugin`](/docs/reference/api/ottervoice-core/#voiceagentplugin) | Optional higher-level dialog plugin (opening line, next line, finish rule). | [packages/core/src/types.ts:1211](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1211) |
...
| <a id="audiollmretry"></a> `audioLlmRetry?` | [`AudioLLMRetryPolicy`](/docs/reference/api/ottervoice-core/#audiollmretrypolicy) | Retry/recovery behavior for each native Audio LLM turn. See [AudioLLMRetryPolicy](/docs/reference/api/ottervoice-core/#audiollmretrypolicy); server idempotency and budgets remain authoritative. | [packages/core/src/types.ts:1193](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1193) |
...
| <a id="policy"></a> `policy?` | [`VoiceSessionPolicy`](/docs/reference/api/ottervoice-core/#voicesessionpolicy) | Session-level timers and barge-in recovery knobs. | [packages/core/src/types.ts:1221](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1221) |
| <a id="providers"></a> `providers` | \{ `asr`: [`ASRProvider`](/docs/reference/api/ottervoice-core/#asrprovider); `audioLlm?`: [`AudioLLMProvider`](/docs/reference/api/ottervoice-core/#audiollmprovider); `llm`: [`LLMProvider`](/docs/reference/api/ottervoice-core/#llmprovider); `pronunciation?`: [`PronunciationProvider`](/docs/reference/api/ottervoice-core/#pronunciationprovider); `tts?`: [`TTSProvider`](/docs/reference/api/ottervoice-core/#ttsprovider); \} | - | [packages/core/src/types.ts:1198](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1198) |
| `providers.asr` | [`ASRProvider`](/docs/reference/api/ottervoice-core/#asrprovider) | Speech-to-text provider (required for live captions / classic pipeline). | [packages/core/src/types.ts:1200](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1200) |
| `providers.audioLlm?` | [`AudioLLMProvider`](/docs/reference/api/ottervoice-core/#audiollmprovider) | Required when `pipeline` is `audio_llm`; ASR supplies captions while request timing follows [VoiceSessionConfig.audioLlmStartTiming](/docs/reference/api/ottervoice-core/#audiollmstarttiming). | [packages/core/src/types.ts:1206](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1206) |
| `providers.llm` | [`LLMProvider`](/docs/reference/api/ottervoice-core/#llmprovider) | Text LLM used by `asr_llm_tts` (and optional agents). | [packages/core/src/types.ts:1202](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1202) |
| `providers.pronunciation?` | [`PronunciationProvider`](/docs/reference/api/ottervoice-core/#pronunciationprovider) | Optional pronunciation scoring after a user turn. | [packages/core/src/types.ts:1208](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1208) |
| `providers.tts?` | [`TTSProvider`](/docs/reference/api/ottervoice-core/#ttsprovider) | Text-to-speech; required when `pipeline` is `asr_llm_tts`. | [packages/core/src/types.ts:1204](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1204) |
| <a id="runtime"></a> `runtime` | [`RuntimeAdapter`](/docs/reference/api/ottervoice-core/#runtimeadapter) | Platform audio (and optional network/storage/logger) adapter. | [packages/core/src/types.ts:1197](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1197) |
| <a id="turndetection"></a> `turnDetection?` | [`TurnDetectionConfig`](/docs/reference/api/ottervoice-core/#turndetectionconfig) | VAD / endpointing while listening for the user. | [packages/core/src/types.ts:1213](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1213) |
...
| <a id="role-2"></a> `role` | [`TurnRole`](/docs/reference/api/ottervoice-core/#turnrole) | Who spoke this turn. | [packages/core/src/types.ts:121](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L121) |
...
| <a id="sessiondurationms"></a> `sessionDurationMs` | `number` | Wall time since [VoiceSession.start](/docs/reference/api/ottervoice-core/#start-2). | [packages/core/src/types.ts:142](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L142) |
...
| `providers` | `Omit`\<[`VoiceSessionConfig`](/docs/reference/api/ottervoice-core/#voicesessionconfig)\[`"providers"`\], `"llm"` \| `"audioLlm"`\> & \{ `audioLlm`: [`AudioLLMProvider`](/docs/reference/api/ottervoice-core/#audiollmprovider); `llm?`: `never`; \} | Providers required by an Audio LLM-only session. | [packages/core/src/types.ts:1242](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L1242) |
...
| <a id="finished"></a> `finished` | \{ `turns`: [`VoiceTurn`](/docs/reference/api/ottervoice-core/#voiceturn)[]; \} | Session completed gracefully; turns are the full history. | [packages/core/src/types.ts:245](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L245) |
| `finished.turns` | [`VoiceTurn`](/docs/reference/api/ottervoice-core/#voiceturn)[] | - | [packages/core/src/types.ts:246](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L246) |
| <a id="statechange"></a> `statechange` | \{ `from`: [`VoiceSessionState`](/docs/reference/api/ottervoice-core/#voicesessionstate-1); `reason?`: `string`; `to`: [`VoiceSessionState`](/docs/reference/api/ottervoice-core/#voicesessionstate-1); \} | FSM transition with optional reason string. | [packages/core/src/types.ts:169](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L169) |
| `statechange.from` | [`VoiceSessionState`](/docs/reference/api/ottervoice-core/#voicesessionstate-1) | - | [packages/core/src/types.ts:170](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L170) |
...
| `statechange.to` | [`VoiceSessionState`](/docs/reference/api/ottervoice-core/#voicesessionstate-1) | - | [packages/core/src/types.ts:171](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L171) |
...
| `turn.turn` | [`VoiceTurn`](/docs/reference/api/ottervoice-core/#voiceturn) | - | [packages/core/src/types.ts:240](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L240) |
| <a id="usage-4"></a> `usage` | [`VoiceUsageSnapshot`](/docs/reference/api/ottervoice-core/#voiceusagesnapshot) | Latest usage meters. | [packages/core/src/types.ts:243](https://github.com/bugkiwi/OtterVoice/blob/32a17b53288150ad9b34d3fe77eaca977ba2d063/packages/core/src/types.ts#L243) |
