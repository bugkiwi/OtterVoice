...
| <a id="type"></a> `type` | `T` | Event name (same keys as core [VoiceSessionEventMap](/docs/reference/api/ottervoice-core/#voicesessioneventmap)). | [packages/protocol/src/index.ts:53](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/protocol/src/index.ts#L53) |
| <a id="v"></a> `v` | `1` | Protocol schema version; must equal [PROTOCOL\_VERSION](/docs/reference/api/ottervoice-protocol/#protocol_version). | [packages/protocol/src/index.ts:51](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/protocol/src/index.ts#L51) |
