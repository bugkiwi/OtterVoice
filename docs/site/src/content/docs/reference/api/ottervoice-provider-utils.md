...
| ------ | ------ | ------ | ------ |
| <a id="error"></a> `error?` | [`NormalizedVoiceError`](/docs/reference/api/ottervoice-core/#normalizedvoiceerror) | Provider-reported or decode-time failure for this frame. | [websocket.ts:54](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/websocket.ts#L54) |
| <a id="final"></a> `final?` | [`ASRResult`](/docs/reference/api/ottervoice-core/#asrresult) | Finalized transcript segment, if this frame ends an utterance. | [websocket.ts:52](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/websocket.ts#L52) |
| <a id="partial"></a> `partial?` | [`ASRResult`](/docs/reference/api/ottervoice-core/#asrresult) | Incremental (non-final) transcript, if this frame carries one. | [websocket.ts:50](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/websocket.ts#L50) |
...
| <a id="purpose"></a> `purpose` | [`CredentialPurpose`](/docs/reference/api/ottervoice-provider-utils/#credentialpurpose) | Why the token is needed so the broker can scope permissions. | [credential.ts:15](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/credential.ts#L15) |
...
| <a id="fetch"></a> `fetch?` | [`FetchLike`](/docs/reference/api/ottervoice-provider-utils/#fetchlike) | Custom `fetch` implementation (tests / React Native polyfills). | [credential.ts:44](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/credential.ts#L44) |
...
| Property | Type | Description | Defined in |
| ------ | ------ | ------ | ------ |
| <a id="failurecode"></a> `failureCode?` | [`VoiceErrorCode`](/docs/reference/api/ottervoice-core/#voiceerrorcode-1) | Code to use for ordinary 4xx failures (e.g. `llm_failed`, `tts_failed`). | [http.ts:35](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/http.ts#L35) |
| <a id="provider-1"></a> `provider?` | `string` | Vendor id attached to the resulting [NormalizedVoiceError](/docs/reference/api/ottervoice-core/#normalizedvoiceerror). | [http.ts:33](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/http.ts#L33) |
...
| <a id="provider-2"></a> `provider` | `string` | Vendor id used in emitted [NormalizedVoiceError](/docs/reference/api/ottervoice-core/#normalizedvoiceerror)s. | [websocket.ts:66](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/websocket.ts#L66) |
| <a id="ws"></a> `ws` | [`WebSocketLike`](/docs/reference/api/ottervoice-provider-utils/#websocketlike) | Open (or about-to-open) socket used for the ASR stream. | [websocket.ts:64](https://github.com/bugkiwi/OtterVoice/blob/2bfc8092126714d41319b22544fc5f9414c591f5/packages/provider-utils/src/websocket.ts#L64) |
